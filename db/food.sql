...
CREATE TABLE `orders` (
  ...
  `total_order` varchar(1000) NOT NULL,
...
INSERT INTO `orders` (`id`, `user_id`, `name`, `number`, `email`, `method`, `address`, `total_order`, `total_price`, `placed_on`, `payment_status`) VALUES
